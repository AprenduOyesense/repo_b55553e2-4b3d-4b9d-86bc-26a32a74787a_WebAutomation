...
public class fsfasdfsadfasfsdfas {

    private WebDriver driver;
    private String className = "fsfasdfsadfasfsdfas";
    private String subid = "II5xv7iYe";

    // Constructor to initialize WebDriver and set className and subid
    public fsfasdfsadfasfsdfas(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        fsfasdfsadfasfsdfas test = new fsfasdfsadfasfsdfas(driver);
        test.runTest();
    }
}
