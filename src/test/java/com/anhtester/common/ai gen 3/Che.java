...
public class CheckUserSessionTimeout {

    private WebDriver driver;
    private String className = "CheckUserSessionTimeout";
    private String subid = "V9oYOHvJO2";

    // Constructor to initialize WebDriver and set className and subid
    public CheckUserSessionTimeout(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckUserSessionTimeout test = new CheckUserSessionTimeout(driver);
        test.runTest();
    }
}
