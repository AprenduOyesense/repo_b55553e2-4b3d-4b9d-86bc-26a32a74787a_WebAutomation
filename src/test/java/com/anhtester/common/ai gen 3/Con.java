...
public class ConfirmPasswordChangewithExistingPassword {

    private WebDriver driver;
    private String className = "ConfirmPasswordChangewithExistingPassword";
    private String subid = "-Nsa2w5YKNn";

    // Constructor to initialize WebDriver and set className and subid
    public ConfirmPasswordChangewithExistingPassword(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ConfirmPasswordChangewithExistingPassword test = new ConfirmPasswordChangewithExistingPassword(driver);
        test.runTest();
    }
}
