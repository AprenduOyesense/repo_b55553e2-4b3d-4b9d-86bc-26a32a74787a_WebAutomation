...
public class EnsureUserLogoutFunctionality {

    private WebDriver driver;
    private String className = "EnsureUserLogoutFunctionality";
    private String subid = "qI0dmV_6jVl";

    // Constructor to initialize WebDriver and set className and subid
    public EnsureUserLogoutFunctionality(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EnsureUserLogoutFunctionality test = new EnsureUserLogoutFunctionality(driver);
        test.runTest();
    }
}
