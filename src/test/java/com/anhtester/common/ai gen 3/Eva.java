...
public class EvaluateUserAccountBanningFunctionality {

    private WebDriver driver;
    private String className = "EvaluateUserAccountBanningFunctionality";
    private String subid = "4L201EMh1R3";

    // Constructor to initialize WebDriver and set className and subid
    public EvaluateUserAccountBanningFunctionality(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EvaluateUserAccountBanningFunctionality test = new EvaluateUserAccountBanningFunctionality(driver);
        test.runTest();
    }
}
