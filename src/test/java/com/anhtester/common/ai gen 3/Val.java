...
public class ValidateUserAccountReactivation {

    private WebDriver driver;
    private String className = "ValidateUserAccountReactivation";
    private String subid = "x1LaZJPICG";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateUserAccountReactivation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateUserAccountReactivation test = new ValidateUserAccountReactivation(driver);
        test.runTest();
    }
}
