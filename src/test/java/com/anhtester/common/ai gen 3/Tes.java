...
public class TestUserAccountSuspensionFunctionality {

    private WebDriver driver;
    private String className = "TestUserAccountSuspensionFunctionality";
    private String subid = "It9Jw5J16rr";

    // Constructor to initialize WebDriver and set className and subid
    public TestUserAccountSuspensionFunctionality(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        TestUserAccountSuspensionFunctionality test = new TestUserAccountSuspensionFunctionality(driver);
        test.runTest();
    }
}
