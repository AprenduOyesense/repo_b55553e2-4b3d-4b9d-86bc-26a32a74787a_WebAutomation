...
public class VerifyUserLoginwithCorrectCredentials {

    private WebDriver driver;
    private String className = "VerifyUserLoginwithCorrectCredentials";
    private String subid = "MyU1o4ss8a";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyUserLoginwithCorrectCredentials(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyUserLoginwithCorrectCredentials test = new VerifyUserLoginwithCorrectCredentials(driver);
        test.runTest();
    }
}
