...
public class asdfasfsad {

    private WebDriver driver;
    private String className = "asdfasfsad";
    private String subid = "61TQaaA9D";

    // Constructor to initialize WebDriver and set className and subid
    public asdfasfsad(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        asdfasfsad test = new asdfasfsad(driver);
        test.runTest();
    }
}
