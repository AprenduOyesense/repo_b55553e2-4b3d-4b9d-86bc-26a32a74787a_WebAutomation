...
public class sumoftwodecimals {
    ...
    private String className = "sumoftwodecimals";
    private String subid = "JE20";

    // Constructor to initialize WebDriver and set className and subid
    public sumoftwodecimals(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        sumoftwodecimals test = new sumoftwodecimals(driver);
        test.runTest();
    }
}
