...
public class SumofMultiplenumbers {
    ...
    private String className = "SumofMultiplenumbers";
    private String subid = "JE22";

    // Constructor to initialize WebDriver and set className and subid
    public SumofMultiplenumbers(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        SumofMultiplenumbers test = new SumofMultiplenumbers(driver);
        test.runTest();
    }
}
