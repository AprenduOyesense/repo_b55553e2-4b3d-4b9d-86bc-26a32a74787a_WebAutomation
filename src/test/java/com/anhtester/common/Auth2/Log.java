...
public class Loginwithvalidcreds {
    ...
    private String className = "Loginwithvalidcreds";
    private String subid = "LbFdMac68b";

    // Constructor to initialize WebDriver and set className and subid
    public Loginwithvalidcreds(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Loginwithvalidcreds test = new Loginwithvalidcreds(driver);
        test.runTest();
    }
}
