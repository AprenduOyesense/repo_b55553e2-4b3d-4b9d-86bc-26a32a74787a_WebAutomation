...
public class InvestigateUserLoginProcess {

    private WebDriver driver;
    private String className = "InvestigateUserLoginProcess";
    private String subid = "oDT1oQkFti";

    // Constructor to initialize WebDriver and set className and subid
    public InvestigateUserLoginProcess(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        InvestigateUserLoginProcess test = new InvestigateUserLoginProcess(driver);
        test.runTest();
    }
}
