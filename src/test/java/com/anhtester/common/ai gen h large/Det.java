...
public class DetermineAccountCreationSuccess {

    private WebDriver driver;
    private String className = "DetermineAccountCreationSuccess";
    private String subid = "Xut5AL5-P_";

    // Constructor to initialize WebDriver and set className and subid
    public DetermineAccountCreationSuccess(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        DetermineAccountCreationSuccess test = new DetermineAccountCreationSuccess(driver);
        test.runTest();
    }
}
