...
public class AnalyzePasswordStrengthValidation {

    private WebDriver driver;
    private String className = "AnalyzePasswordStrengthValidation";
    private String subid = "sCzF8e44ib";

    // Constructor to initialize WebDriver and set className and subid
    public AnalyzePasswordStrengthValidation(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AnalyzePasswordStrengthValidation test = new AnalyzePasswordStrengthValidation(driver);
        test.runTest();
    }
}
