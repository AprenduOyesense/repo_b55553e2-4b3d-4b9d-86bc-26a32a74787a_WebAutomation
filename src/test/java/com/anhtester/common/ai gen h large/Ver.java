...
public class VerifyUserAuthentication {
    ...
    private String className = "VerifyUserAuthentication";
    private String subid = "1Cif3oAug";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyUserAuthentication(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyUserAuthentication test = new VerifyUserAuthentication(driver);
        test.runTest();
    }
}
