...
public class ConfirmPasswordResetFunctionality {

    private WebDriver driver;
    private String className = "ConfirmPasswordResetFunctionality";
    private String subid = "-mp9hT_rhR";

    // Constructor to initialize WebDriver and set className and subid
    public ConfirmPasswordResetFunctionality(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ConfirmPasswordResetFunctionality test = new ConfirmPasswordResetFunctionality(driver);
        test.runTest();
    }
}
