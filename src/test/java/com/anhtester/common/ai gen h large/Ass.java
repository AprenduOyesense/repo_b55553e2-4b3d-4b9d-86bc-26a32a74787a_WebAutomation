...
public class AssessEmailVerification {

    private WebDriver driver;
    private String className = "AssessEmailVerification";
    private String subid = "vxC42RUsjE";

    // Constructor to initialize WebDriver and set className and subid
    public AssessEmailVerification(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AssessEmailVerification test = new AssessEmailVerification(driver);
        test.runTest();
    }
}
