...
public class ExploreProfileInformationUpdate {

    private WebDriver driver;
    private String className = "ExploreProfileInformationUpdate";
    private String subid = "lNJEU4uphN";

    // Constructor to initialize WebDriver and set className and subid
    public ExploreProfileInformationUpdate(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ExploreProfileInformationUpdate test = new ExploreProfileInformationUpdate(driver);
        test.runTest();
    }
}
