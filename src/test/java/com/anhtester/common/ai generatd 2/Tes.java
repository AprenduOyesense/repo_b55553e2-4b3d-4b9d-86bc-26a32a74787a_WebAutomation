...
public class Testuserauthorization {
    ...
    private String className = "Testuserauthorization";
    private String subid = "nfEWytLO3Mm";

    // Constructor to initialize WebDriver and set className and subid
    public Testuserauthorization(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Testuserauthorization test = new Testuserauthorization(driver);
        test.runTest();
    }
}
