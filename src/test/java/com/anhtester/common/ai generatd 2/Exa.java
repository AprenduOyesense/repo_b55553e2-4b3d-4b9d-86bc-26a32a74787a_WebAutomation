...
public class Examineusersortingoptions {

    private WebDriver driver;
    private String className = "Examineusersortingoptions";
    private String subid = "Y6hsOlYg5tR";

    // Constructor to initialize WebDriver and set className and subid
    public Examineusersortingoptions(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Examineusersortingoptions test = new Examineusersortingoptions(driver);
        test.runTest();
    }
}
