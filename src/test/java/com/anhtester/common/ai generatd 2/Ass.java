...
public class Assessintegrationwithothersystems {

    private WebDriver driver;
    private String className = "Assessintegrationwithothersystems";
    private String subid = "7Njw7Gtxi1";

    // Constructor to initialize WebDriver and set className and subid
    public Assessintegrationwithothersystems(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Assessintegrationwithothersystems test = new Assessintegrationwithothersystems(driver);
        test.runTest();
    }
}
