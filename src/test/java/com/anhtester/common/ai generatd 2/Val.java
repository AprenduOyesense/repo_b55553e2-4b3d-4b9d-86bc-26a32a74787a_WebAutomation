...
public class Validateuserauthentication {

    private WebDriver driver;
    private String className = "Validateuserauthentication";
    private String subid = "PA1344";

    // Constructor to initialize WebDriver and set className and subid
    public Validateuserauthentication(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Validateuserauthentication test = new Validateuserauthentication(driver);
        test.runTest();
    }
}
