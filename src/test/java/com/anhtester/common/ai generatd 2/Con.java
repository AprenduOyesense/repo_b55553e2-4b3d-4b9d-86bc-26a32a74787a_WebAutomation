...
public class Confirmuserdataexportoptions {

    private WebDriver driver;
    private String className = "Confirmuserdataexportoptions";
    private String subid = "oBvIyVU1y6L";

    // Constructor to initialize WebDriver and set className and subid
    public Confirmuserdataexportoptions(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Confirmuserdataexportoptions test = new Confirmuserdataexportoptions(driver);
        test.runTest();
    }
}
