...
public class Verifyemailnotifications {

    private WebDriver driver;
    private String className = "Verifyemailnotifications";
    private String subid = "8Be96NQHmvO";

    // Constructor to initialize WebDriver and set className and subid
    public Verifyemailnotifications(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Verifyemailnotifications test = new Verifyemailnotifications(driver);
        test.runTest();
    }
}
