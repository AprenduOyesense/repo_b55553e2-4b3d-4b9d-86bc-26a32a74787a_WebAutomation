...
public class Checkresponsivenessondifferentscreensizes {

    private WebDriver driver;
    private String className = "Checkresponsivenessondifferentscreensizes";
    private String subid = "EgeRIJNOkb";

    // Constructor to initialize WebDriver and set className and subid
    public Checkresponsivenessondifferentscreensizes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Checkresponsivenessondifferentscreensizes test = new Checkresponsivenessondifferentscreensizes(driver);
        test.runTest();
    }
}
