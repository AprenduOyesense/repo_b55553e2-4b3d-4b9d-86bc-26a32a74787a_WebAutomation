...
public class fasdfasdfsaasdfasd {

    private WebDriver driver;
    private String className = "fasdfasdfsaasdfasd";
    private String subid = "PA82";

    // Constructor to initialize WebDriver and set className and subid
    public fasdfasdfsaasdfasd(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        fasdfasdfsaasdfasd test = new fasdfasdfsaasdfasd(driver);
        test.runTest();
    }
}
