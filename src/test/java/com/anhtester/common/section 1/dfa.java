...
public class dfasdfadasdfas {

    private WebDriver driver;
    private String className = "dfasdfadasdfas";
    private String subid = "KA04";

    // Constructor to initialize WebDriver and set className and subid
    public dfasdfadasdfas(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        dfasdfadasdfas test = new dfasdfadasdfas(driver);
        test.runTest();
    }
}
