...
public class sdadfafasabducted {

    private WebDriver driver;
    private String className = "sdadfafasabducted";
    private String subid = "KA01";

    // Constructor to initialize WebDriver and set className and subid
    public sdadfafasabducted(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        sdadfafasabducted test = new sdadfafasabducted(driver);
        test.runTest();
    }
}
