...
public class EnsureProperInputFieldValidationwithSpecialCharactersinDataExports {

    private WebDriver driver;
    private String className = "EnsureProperInputFieldValidationwithSpecialCharactersinDataExports";
    private String subid = "V6f8tW1Qbca";

    // Constructor to initialize WebDriver and set className and subid
    public EnsureProperInputFieldValidationwithSpecialCharactersinDataExports(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EnsureProperInputFieldValidationwithSpecialCharactersinDataExports test = new EnsureProperInputFieldValidationwithSpecialCharactersinDataExports(driver);
        test.runTest();
    }
}
