...
public class AnalyzeInputFieldValidationwithSpecialCharactersinSystemConfiguration {

    private WebDriver driver;
    private String className = "AnalyzeInputFieldValidationwithSpecialCharactersinSystemConfiguration";
    private String subid = "knsf2LG6Y7y";

    // Constructor to initialize WebDriver and set className and subid
    public AnalyzeInputFieldValidationwithSpecialCharactersinSystemConfiguration(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AnalyzeInputFieldValidationwithSpecialCharactersinSystemConfiguration test = new AnalyzeInputFieldValidationwithSpecialCharactersinSystemConfiguration(driver);
        test.runTest();
    }
}
