...
public class CheckforInputFieldLengthLimitations {

    private WebDriver driver;
    private String className = "CheckforInputFieldLengthLimitations";
    private String subid = "XrgmY7RxNW";

    // Constructor to initialize WebDriver and set className and subid
    public CheckforInputFieldLengthLimitations(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        CheckforInputFieldLengthLimitations test = new CheckforInputFieldLengthLimitations(driver);
        test.runTest();
    }
}
