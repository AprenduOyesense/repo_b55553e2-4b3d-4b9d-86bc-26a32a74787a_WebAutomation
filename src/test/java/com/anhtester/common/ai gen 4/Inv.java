...
public class InvestigateInputFieldValidationwithMixedCaseInput {

    private WebDriver driver;
    private String className = "InvestigateInputFieldValidationwithMixedCaseInput";
    private String subid = "dWTTaFVG3R";

    // Constructor to initialize WebDriver and set className and subid
    public InvestigateInputFieldValidationwithMixedCaseInput(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        InvestigateInputFieldValidationwithMixedCaseInput test = new InvestigateInputFieldValidationwithMixedCaseInput(driver);
        test.runTest();
    }
}
