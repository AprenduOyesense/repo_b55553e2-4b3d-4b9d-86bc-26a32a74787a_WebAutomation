...
public class ConfirmInputFieldValidationwithBackslashes {

    private WebDriver driver;
    private String className = "ConfirmInputFieldValidationwithBackslashes";
    private String subid = "UTowqe2_xf_";

    // Constructor to initialize WebDriver and set className and subid
    public ConfirmInputFieldValidationwithBackslashes(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ConfirmInputFieldValidationwithBackslashes test = new ConfirmInputFieldValidationwithBackslashes(driver);
        test.runTest();
    }
}
