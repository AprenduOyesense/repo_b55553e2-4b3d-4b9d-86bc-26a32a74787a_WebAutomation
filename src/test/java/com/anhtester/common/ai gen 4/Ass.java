...
public class AssessInputFieldValidationwithLeadingandTrailingSpaces {

    private WebDriver driver;
    private String className = "AssessInputFieldValidationwithLeadingandTrailingSpaces";
    private String subid = "2U7Z2qCuqq";

    // Constructor to initialize WebDriver and set className and subid
    public AssessInputFieldValidationwithLeadingandTrailingSpaces(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        AssessInputFieldValidationwithLeadingandTrailingSpaces test = new AssessInputFieldValidationwithLeadingandTrailingSpaces(driver);
        test.runTest();
    }
}
