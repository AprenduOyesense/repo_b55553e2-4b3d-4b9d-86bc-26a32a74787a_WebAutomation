...
public class TestInputFieldValidationwithSpecialCharactersinUserFeedback {

    private WebDriver driver;
    private String className = "TestInputFieldValidationwithSpecialCharactersinUserFeedback";
    private String subid = "ghvFoRkx46r";

    // Constructor to initialize WebDriver and set className and subid
    public TestInputFieldValidationwithSpecialCharactersinUserFeedback(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        TestInputFieldValidationwithSpecialCharactersinUserFeedback test = new TestInputFieldValidationwithSpecialCharactersinUserFeedback(driver);
        test.runTest();
    }
}
