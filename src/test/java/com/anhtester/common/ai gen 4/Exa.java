...
public class ExamineInputFieldValidationwithDecimalNumbers {

    private WebDriver driver;
    private String className = "ExamineInputFieldValidationwithDecimalNumbers";
    private String subid = "_6A6_yhqVO";

    // Constructor to initialize WebDriver and set className and subid
    public ExamineInputFieldValidationwithDecimalNumbers(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ExamineInputFieldValidationwithDecimalNumbers test = new ExamineInputFieldValidationwithDecimalNumbers(driver);
        test.runTest();
    }
}
