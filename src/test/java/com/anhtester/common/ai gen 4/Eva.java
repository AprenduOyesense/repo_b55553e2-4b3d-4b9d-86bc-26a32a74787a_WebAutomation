...
public class EvaluateInputFieldValidationwithInputLimits {

    private WebDriver driver;
    private String className = "EvaluateInputFieldValidationwithInputLimits";
    private String subid = "o9BbfTs-e0";

    // Constructor to initialize WebDriver and set className and subid
    public EvaluateInputFieldValidationwithInputLimits(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        EvaluateInputFieldValidationwithInputLimits test = new EvaluateInputFieldValidationwithInputLimits(driver);
        test.runTest();
    }
}
