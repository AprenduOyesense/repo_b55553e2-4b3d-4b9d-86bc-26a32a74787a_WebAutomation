...
public class ValidateUserInputforSpecialCharacters {

    private WebDriver driver;
    private String className = "ValidateUserInputforSpecialCharacters";
    private String subid = "RjkeHcBtN";

    // Constructor to initialize WebDriver and set className and subid
    public ValidateUserInputforSpecialCharacters(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        ValidateUserInputforSpecialCharacters test = new ValidateUserInputforSpecialCharacters(driver);
        test.runTest();
    }
}
