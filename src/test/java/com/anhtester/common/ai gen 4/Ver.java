...
public class VerifyInputFieldValidationwithDuplicateInput {

    private WebDriver driver;
    private String className = "VerifyInputFieldValidationwithDuplicateInput";
    private String subid = "p8PNPnhNsC";

    // Constructor to initialize WebDriver and set className and subid
    public VerifyInputFieldValidationwithDuplicateInput(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        VerifyInputFieldValidationwithDuplicateInput test = new VerifyInputFieldValidationwithDuplicateInput(driver);
        test.runTest();
    }
}
