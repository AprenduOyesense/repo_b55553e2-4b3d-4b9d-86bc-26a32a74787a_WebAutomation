...
public class subtractionoftwonumbers {
    ...
    private String className = "subtractionoftwonumbers";
    private String subid = "JE10";

    // Constructor to initialize WebDriver and set className and subid
    public subtractionoftwonumbers(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        subtractionoftwonumbers test = new subtractionoftwonumbers(driver);
        test.runTest();
    }
}
