...
public class Substractionofanynumber {

    private WebDriver driver;
    private String className = "Substractionofanynumber";
    private String subid = "TE02";

    // Constructor to initialize WebDriver and set className and subid
    public Substractionofanynumber(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Substractionofanynumber test = new Substractionofanynumber(driver);
        test.runTest();
    }
}
