...
public class fasdfasdfasa {

    private WebDriver driver;
    private String className = "fasdfasdfasa";
    private String subid = "uj4aLZ_D6";

    // Constructor to initialize WebDriver and set className and subid
    public fasdfasdfasa(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        fasdfasdfasa test = new fasdfasdfasa(driver);
        test.runTest();
    }
}
