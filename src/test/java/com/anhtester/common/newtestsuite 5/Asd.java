...
public class Asdfasdfasdfas {

    private WebDriver driver;
    private String className = "Asdfasdfasdfas";
    private String subid = "PA04";

    // Constructor to initialize WebDriver and set className and subid
    public Asdfasdfasdfas(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        Asdfasdfasdfas test = new Asdfasdfasdfas(driver);
        test.runTest();
    }
}
