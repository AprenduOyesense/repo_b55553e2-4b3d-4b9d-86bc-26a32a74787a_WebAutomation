...
public class 9124testsubject {

    private WebDriver driver;
    private String className = "9124testsubject";
    private String subid = "PA03";

    // Constructor to initialize WebDriver and set className and subid
    public 9124testsubject(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        9124testsubject test = new 9124testsubject(driver);
        test.runTest();
    }
}
